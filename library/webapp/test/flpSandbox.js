		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comiblibrary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comiblibrary-display": {
								"semanticObject": "comiblibrary",
								"action": "display",
								"description": "An SAP Fiori application. CRUD operation project for learning. ",
								"title": "Library management system",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ib.library",
									"url": sap.ui.require.toUrl("com/ib/library")
								}
							}
						}
					}
