		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo Customer",
									"targetURL": "#comibdemocustomer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibdemocustomer-display": {
								"semanticObject": "comibdemocustomer",
								"action": "display",
								"description": "A Fiori application demo customer",
								"title": "Demo Customer",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ib.democustomer",
									"url": sap.ui.require.toUrl("com/ib/democustomer")
								}
							}
						}
					}
